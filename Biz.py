...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://cutewallpaper.org/27x/x1utbtvdz/74537239.jpg");
                        background-size: cover}}
                     </style>""",unsafe_allow_html=True) 
setting_bg()

# CREATING OPTION MENUs
selected = option_menu(None, ["Upload & Extract","Modify", "About"], 
                       icons=["house","cloud-upload","pencil-square","exclamation-lg"],
                       default_index=0,
...
# TABLE CREATION
mycursor.execute('''CREATE TABLE IF NOT EXISTS card_data(id INTEGER PRIMARY KEY AUTO_INCREMENT,company_name TEXT,card_holder TEXT,designation TEXT,
                    mobile_number VARCHAR(50),email TEXT,website TEXT,area TEXT,city TEXT,state TEXT,pin_code VARCHAR(10),image LONGBLOB)''')
